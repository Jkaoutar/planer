      ...
      <div class="first">
       ...
       <!-- <ul class="social">
         ...
         <div class="container" style="margin-top:5%; background-color:rgba(105, 103, 103,0.5);" >
            <form action="{{ route('ModificationGlobalPost') }}" enctype="multipart/form-data" method="post">
                @csrf
            <div class="row">
           ...
           <center> <h5>  Informations sur le projet</h5></center>
                    <div class="form-group" style="margin-top:2%;">
                        <input class="form-control form-control-sm" type="text" value="{{$societes->id}}" name="id" hidden>
                      <input class="form-control form-control-sm" type="text" value="{{$societes->Entreprise}}" name="entreprise" placeholder="Nom d'Entreprise">
                      
                    </div>
                    <div class="form-group">
                        
                        <input class="form-control form-control-sm" type="text" value="{{$societes->IntituleProjet}}" name="projet" placeholder="Intitulé du Projet">
                    </div>
                    <div class="form-group">
                       
                        <input class="form-control form-control-sm" type="text" value="{{$societes->BrancheActivitee}}" name="branche" placeholder="Branche d'activitée">
                    </div>
                    <div class="form-group">
                       
                        <input class="form-control form-control-sm" type="text" name="programme" value="{{$societes->ProgrammeInvestissement}}" placeholder="Programme d'Investissement TTC Chiffres">
                    </div>
                    <div class="form-group">
                       
                        <input type="text" id="datepicker" name="date" class="form-control form-control-sm" value="{{$societes->DateSignature}}" placeholder="Date de signature de la convention ">
                    </div>
                    <div class="form-group">
                      
                            <input class="form-control form-control-sm" type="text" value="{{$societes->EmploisPrevus}}" name="Emplois" placeholder="Emplois prévus">
                    </div>
                    <div class="form-group">
                       
                        <input type="text" id="datepicker" name="EmploisR" value="{{$societes->EmploisReels}}" class="form-control form-control-sm" placeholder="Emplois réels ">
                    </div>
           ...
           <center> <h5> Avancement dans le projet</h5></center>
                    <div class="form-group" style="margin-top:2%;">
                      ...
                      <select class="form-select form-control-sm form-control" aria-label="Mobilisation terrain"  name="Mobilisation" >
                        <option value="{{$societes->MobilisationTerrain}}" disabled selected>Mobilisation du Terrain : {{$societes->MobilisationTerrain}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select form-control-sm form-control" aria-label="Paiement Terrain"  name="Paiement" >
                            <option  value="{{$societes->PaiementTerrain}}" disabled selected>Paiement Terrain :  {{$societes->PaiementTerrain}} </option>
                            <option value="Oui">Oui</option>
                            <option value="Non">Non</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select form-control-sm form-control" aria-label="Autorisation de construire"  name="autorisation" >
                            <option  value="{{$societes->AutorisationConstruire}}" disabled selected>Autorisation de construire :  {{$societes->AutorisationConstruire}}</option>
                            <option value="Oui">Oui</option>
                            <option value="Non">Non</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select form-control-sm form-control" aria-label=" Construction Pourcent" name="programme" >
                            <option  value="{{$societes->Construction}}" disabled selected> Construction Pourcent :  {{$societes->Construction}}</option>
                    ...
                    <div class="form-group">
                            ...
                            <select class="form-select form-control-sm form-control" aria-label=" Etapes administratives"  name="EtapesAdministratives" >
                                <option   {{$societes->EtapesAdministratives}}disabled selected> Etapes administratives :  {{$societes->EtapesAdministratives}}</option>
