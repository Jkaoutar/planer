         ...
         <div class="container" style="margin-top:5%; background-color:rgba(105, 103, 103,0.5);" >
           ...
           <center> <h5> Avancement dans le projet</h5></center>
                    <div class="form-group" style="margin-top:2%;">
                      ...
                      <input class="form-control form-control-sm" type="text" name="Mobilisation" placeholder="Mobilisation terrain">
                      
                    </div>
                    <div class="form-group">
                        
                        <input class="form-control form-control-sm" type="text" name="Paiement" placeholder="Paiement Terrain">
                    </div>
                    <div class="form-group">
                       
                        <input class="form-control form-control-sm" type="text" name="autorisation" placeholder="Autorisation de construire">
                    </div>
                    <div class="form-group">
                       
                        <input class="form-control form-control-sm" type="text" name="programme" placeholder=" Construction Pourcent">
                    </div>
                    
                    <div class="form-group">
                      
                            <input class="form-control form-control-sm" type="text" name="Emplois" placeholder="Etapes administratives">
                    </div>
